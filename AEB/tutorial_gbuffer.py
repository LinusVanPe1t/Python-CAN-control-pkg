...
def main():
    ...
    try:
        ...
        # Now we need to give an initial transform to the vehicle. We take the
        # first recommended spawn point and move it a few meters forward so the
        # vehicle spawns straight ahead of the reference orientation.
        ...
        # Keep autopilot off so the vehicle stays where it is.
